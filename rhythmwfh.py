...
def openSpiralBrowserWindow():
    ...
    startbtn = driver.find_element_by_xpath(
...
def runYoutube():
    ...
    time.sleep(3)
    try:
        playbtn = driver.find_element_by_xpath(
            '//*[@id="movie_player"]/div[4]/button')
        playbtn.click()
    except:
        pass
    time.sleep(10)
    githublink = driver.find_element_by_xpath(
        '//*[@id="description"]/yt-formatted-string/a')
    githublink.click()
    time.sleep(5)
    driver.close()
...
def checkGithub():
    ...
    time.sleep(3)
    goToRepo = driver.find_element_by_xpath(
        '//*[@id="js-pjax-container"]/div[1]/div/div/div[2]/div/nav/a[2]')
    goToRepo.click()
    time.sleep(3)
    x, y = pyautogui.size()
    ...
    driver.get('https://github.com/rhythmbhiwani/webdev-drumkit')
    time.sleep(1)
    scroll(-3, x=x//2, y=x//2, sleeptime=1)
    livewebsite = driver.find_element_by_xpath(
        '//*[@id="readme"]/div[3]/article/p/a')
    livewebsite.click()
    time.sleep(5)
...
def writeCodeInNano():
    ...
    pyautogui.typewrite(
        'Hello this is the workfromhome command made by RHYTHM BHIWANI\n', interval=0.1)
    pyautogui.typewrite(
        'Check this out at https://github.com/AdHoc-Interns/WorkFromHomen', interval=0.1)
...
all_actions = [writeCodeInNano, openTerminal1,
               checkGithub, runYoutube, openSpiralBrowserWindow]
try:
